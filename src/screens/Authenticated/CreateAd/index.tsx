...
export function CreateAd() {
  ...
  const RenderForm = ({ value }) => {
    ...
    case "Veiculos":
      return (
        <>
          <VeichleForm atInfo={atInfo}/>
        </>
      );
    case "Produtos":
      return (
        <>
          <ProductsForm atInfo={atInfo}/>
        </>
      );
    case "Serviços":
      return (
        <>
          <ServicesForm atInfo={atInfo} />
        </>
      );
    default:
      return <></>;
    ...
    <Container>
      ...
      >
        <ContentAddImage length={length}>
          {images.length === 0 ? (
            <CardAddImage onPress={pickImage}>
              ...
              <TextInfoImage>
                                Escolha até 6 fotos e 1 video para mostrar o seu
                                produto!
              </TextInfoImage>
            </CardAddImage>
          ) : (
        ...
        {images.length >= 1 && images.length <= 5 && (
          <Animated.View
            entering={ZoomInRight.delay(800)}
            exiting={FlipOutXDown.delay(700)}
          >
            <ImageIndexes>
        ...
        <Form>
          ...
          <ViewModal>
            <Button
              ...
              color={ country ? theme.colors.success : theme.colors.text}
            />
            <BottomSheetModal
          ...
          <Button
            color={ item?.name ? theme.colors.success : theme.colors.text}
            onPress={handleSubmit(onSubmit)}
            title={
              item?.name ? item?.name : "Selecione a categoria"
            }
          />
